...
public interface IStreamDeckHidComDriver
{
    ...
    /// <summary>
    /// Gets the native device key size in pixel.
    /// </summary>
    int KeyImageSize { get; }
    ...
    /// <remarks>
    /// <para>
    /// See <see cref="IKeyIdMapper"/> for details.
    /// </para>
    /// </remarks>
    IKeyIdMapper KeyIdMapper { get; }

    /// <summary>
    /// Generate the payload for a given <paramref name="image"/>.
    /// </summary>
    byte[] GeneratePayload(Image<Bgr24> image);
